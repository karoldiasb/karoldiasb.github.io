...
case 4:
    /*! Production::    comando : DESENHE_LINHA ponto */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 18 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
